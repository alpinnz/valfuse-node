 ...
 *
 * Runs **before** validation so rules always operate on already-transformed
 * values (e.g. a trimmed string or a coerced number).
 *
 * @example
 * const schema = createSchema({
 *   email: { type: "string", transform: t.pipe(t.trim, t.toLowerCase), rules: [...] },
 *   age:   { type: "number", transform: t.toNumber, rules: [...] },
 * });
 *
